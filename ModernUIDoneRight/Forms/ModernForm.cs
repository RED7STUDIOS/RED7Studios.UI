...
using RED7Studios.UI.Native;
using RED7Studios.UI.Objects;
using RED7Studios.UI.Objects.Interaction;
...
namespace RED7Studios.UI.Forms
{
        ...
        protected override void OnLoad(EventArgs e)
        {
            if (!DesignMode)
            {
                ...
                if ((ShadowType.Equals(ShadowType.AeroShadow) || ShadowType.Equals(ShadowType.Default)) &&
                    Native.DwmNative.ExtendFrameIntoClientArea(this, 0, 0, 0, 1))
                {
                    //We can! Tell windows to allow the rendering to happen on our borderless form
                    Native.DwmNative.AllowRenderInBorderless(this);
                }
